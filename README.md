...
## Cara Penggunaan
1.  Buka aplikasi melalui tautan rilis.
2.  Masukkan nama dan semester kamu.
3.  Input Nama Mata Kuliah, bobot SKS, dan pilih Nilai Huruf.
4.  Jika ingin menghitung IPK, masukkan Total SKS Semester Lalu dan IPK Terakhir kamu pada bagian bawah.
5.  Gunakan tombol **PDF** atau **PNG** untuk menyimpan hasil simulasi.
